...
import { Button } from "antd"; // Changed to Ant Design Button
...
export function DayCellV2({ cell, events, eventPositions }: IProps) {
        ...
        <DroppableArea date={date} className="w-full h-full py-2">
          ...
          >
            {(cellEvents.length === 0 && !isMobile) ? (
              <div className="w-full h-full flex justify-center items-center group opacity-0 group-hover:opacity-100 transition-opacity duration-200">
